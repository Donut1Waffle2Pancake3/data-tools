...
const NAV_GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'json-toml', href: 'json-toml/index.html', label: 'JSON ↔ TOML' },
...
const RELATED_TOOL_OVERRIDES = {
  ...
  'json-viewer': ['json-transformer', 'json-diff', 'json-formatter'],
  ...
  'text-diff': ['csv-diff', 'json-diff', 'remove-duplicate-lines'],
  ...
  'csv-deduplicator': ['csv-diff', 'csv-column-analyzer', 'remove-duplicate-lines'],
  ...
  'json-formatter': ['json-yaml', 'json-toml', 'json-diff', 'json-schema-generator'],
  'json-validator': ['json-yaml', 'json-toml', 'json-transformer', 'json-formatter'],
  'json-schema-generator': ['json-validator', 'json-viewer', 'json-formatter'],
  'json-diff': ['json-transformer', 'json-viewer', 'json-formatter'],
  'json-transformer': ['json-yaml', 'json-toml', 'json-formatter', 'json-viewer'],
  'json-yaml': ['json-toml', 'json-formatter', 'json-validator'],
  'json-toml': ['json-yaml', 'json-formatter', 'json-validator'],
