...
| JSON ↔ TOML | [tinydatatool.com/json-toml/](https://tinydatatool.com/json-toml/) |
...
| Tool | URL |
|------|-----|
| Text Diff Checker | [tinydatatool.com/text-diff/](https://tinydatatool.com/text-diff/) |
| Remove Duplicate Lines | [tinydatatool.com/remove-duplicate-lines/](https://tinydatatool.com/remove-duplicate-lines/) |
| Sort Lines | [tinydatatool.com/sort-lines/](https://tinydatatool.com/sort-lines/) |
...
| URL Encoder / Decoder | [tinydatatool.com/url-encoder-decoder/](https://tinydatatool.com/url-encoder-decoder/) |
| HTML Encoder / Decoder | [tinydatatool.com/html-encoder-decoder/](https://tinydatatool.com/html-encoder-decoder/) |
...
| Tool | URL |
|------|-----|
| Batch ZIP Extractor | [tinydatatool.com/zip-combiner/](https://tinydatatool.com/zip-combiner/) |

---

## Converters

Tabular and spreadsheet conversions that are not only JSON- or CSV-only.
